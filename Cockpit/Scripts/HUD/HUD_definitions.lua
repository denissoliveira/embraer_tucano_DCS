...
HUD_strdefs_big	  = {0.010, 0.010, 0, 0}
...
---------------GUN-Pipper-Material---------------------------------------------------------------
HUD_GUNPIPPER_TEXT = MakeMaterial(HUD_TEXTURES_PATH.."VSN_F104_CPT_GUN_C 600x600.tga", GunpipperOrange)
HUD_GUNPIPPER_T_LOCK = MakeMaterial(HUD_TEXTURES_PATH.."VSN_F104_CPT_GUN_C_LOCK 600x600.tga", GunpipperOrange)

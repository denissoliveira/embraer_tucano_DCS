...
{down = iCommandPlaneAutopilot, name = _('Autopilot - Attitude Hold Toggle'), category = _('Autopilot')},
{down = iCommandPlaneStabHbar, name = _('Autopilot - Altitude Hold Toggle'), category = _('Autopilot')},
...
--{down = {{key = 'JOY_BTN5'}},					down = iCommandPlaneModeCannon,					name = _('Cannon'),				category = _('Weapons')},
...
{down = Keys.SetTargetRange_up, name = _('Toggle Target Range up by 100m'), category = _('Gunpipper')},

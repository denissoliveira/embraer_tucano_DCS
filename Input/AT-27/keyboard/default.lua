...
{combos = {{key = 'Y'}},							                    down = Keys.IntercomPTT, up = Keys.IntercomPTT,	                                                name = _('Microphone Switch Intercom'),                         category = _('Systems')},                      value_down =  1, value_up =  0.0,
...
{combos = {{key = 'Space'}},                                            pressed = Keys.PlaneFireOn,	                    up = Keys.PlaneFireOff,                   name = _('Gun-Rocket Trigger'),                                           category = {_('Stick'), _('HOTAS')},        value_down =  1.0,		value_up = 0.0},
{combos = {{key = 'Space',	reformers = {'RAlt'}}},	                    down = Keys.PickleOn,	                        up = Keys.PickleOff,	                name = _('Bomb Release Button'),                        category = {_('Stick'), _('HOTAS')},            value_down =  1.0,		value_up = 0.0},

...
device_commands =
{
	...
	LeftEngineStart                 = __counter(),
	RightEngineStart                = __counter(),
	EngineStartI                     = __counter(),
    EnginePMU                       = __counter(),
    EngineIgnition                  = __counter(),
	EngineIgnitionI                  = __counter(),
    ...
    ASICage                     = __counter(), --puca
    ASIAdjust                   = __counter(), --puca
    SighCage                     = __counter(), --puca
    SighAdjust                   = __counter(), --puca
	adfcage                      = __counter(), --puca
	adfAdjust                    = __counter(), --puca
	rmiseli                   = __counter(), --puca
	JettSwitch                = __counter(), --puca
	JettSwitchSel                = __counter(), --puca
    TACANones                  = __counter(), --puca
	TACANtens                  = __counter(), --puca
	TACANpower                = __counter(), --puca
	Wipersw                   = __counter(), --puca
	tacan_volume              = __counter(), --puca
	VORvolume                 = __counter(), --puca
	VORfreqOnes               = __counter(), --puca
	VORfreqDecimal            = __counter(), --puca
	VORpower                  = __counter(), --puca
	micSwitch                 = __counter(), --puca
	ICSvol                    = __counter(), --puca
	COMM1Switch               = __counter(), --puca
	COMM2Switch               = __counter(), --puca
	throttleMicSwitch         = __counter(), --puca
	COMM1freqCens             = __counter(), --puca
	COMM1freqTens             = __counter(), --puca
	COMM1freqOnes 			  = __counter(), --puca
	COMM1freqTenths		      = __counter(), --puca
	COMM1freqHundredths		  = __counter(), --puca
	COMM1AMFM 		          = __counter(), --puca
	COMM1vol 			      = __counter(), --puca
	COMM1mode 				  = __counter(), --puca
	COMM1brightness			  = __counter(), --puca
	COMM2freqTens             = __counter(), --puca
	COMM2freqOnes             = __counter(), --puca
	COMM2freqTenths           = __counter(), --puca
	COMM2freqHundredths       = __counter(), --puca
	COMM2AMFM                 = __counter(), --puca
	COMM2vol                  = __counter(), --puca
	COMM2mode                 = __counter(), --puca
	COMM2brightness           = __counter(), --puca

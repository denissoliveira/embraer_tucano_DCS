ViewSettings = {
	Cockpit = {
	[1] = {-- player slot 1
		CockpitLocalPoint      = {0.6,0.563,0.0011},--
		...
		EyePoint               = {0.000000,-0.100000,0.000000},--front/back,up/down,left/right}<-'neck dimension'in meters 
		limits_6DOF            = {x = {-0.050000,0.470000},y ={-0.300000,0.100000},z = {-0.250000,0.250000},roll = 90.000000},--Bewegen = hinten vorne,oben unten,links rechts

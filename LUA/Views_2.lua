ViewSettings = {
	Cockpit = {
	[1] = {-- player slot 1
		CockpitLocalPoint      = {0.6,0.563,0.0011},--Cockpit  = front,height 4.705000,1.336000,0.000000
		...
		EyePoint               = {0.6,0.563,0.0012},--front/back,up/down,left/right}<-'neck dimension'in meters 
...
local function head_pos_default(tab)
	...
	tab.y_trans   = tab.y_trans    or  0 --0.083	--0.073			--0.058		-- -0.0083
